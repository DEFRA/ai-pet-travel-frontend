...
> compatibility fEx: `docker build --platform=linux/arm64 --no-cache --tag ai-pet-travel-frontend`

Build:

```bash
docker build --target development --no-cache --tag ai-pet-travel-frontend:development .
```

Run:

```bash
docker run -p 3000:3000 ai-pet-travel-frontend:development
```
...
```bash
docker build --no-cache --tag ai-pet-travel-frontend .
```

Run:

```bash
docker run -p 3000:3000 ai-pet-travel-frontend
```
